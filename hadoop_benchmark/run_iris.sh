...
echo "--- Running MapReduce Job (Iris Benchmark) ---"
# CRITICAL: Capture start time in milliseconds for precision
start_time=$(date +%s.%N)

# Note the change in -files and -mapper to use mapper_iris.py
